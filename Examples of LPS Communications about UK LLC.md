...
**Newsletter template: Existing partner LPS transitioning from COVID-19 research to general research for public good**
```
Update on our partnership with UK Longitudinal Linkage Collaboration:

[Insert LPS name] is part of the UK Longitudinal Linkage Collaboration (UKLLC) and we are letting you know what is changing with them, why, and how it may affect you.

In [Insert year LPS joined UKLLC], [Insert LPS name] came together with similar studies to form UKLLC, to create a research resource to help understand the impacts of the COVID-19 pandemic and develop new treatments.

UKLLC is now preparing to make data available, within its Trusted Research Environment, for any public good research, in addition to COVID-19 research. This will help researchers answer more research questions on important issues that affect people’s health and wellbeing.

For example, they can examine how health and mental health conditions affect care provision among different socio-demographic groups or identify factors that can be modified to reduce health risks.

Some studies in UKLLC will also link to additional datasets, such as education and employment data, if their participants already agreed to this. [Insert LPS name] will not link to this additional data and will continue to link only to health data.

Just as before, the data in the Trusted Research Environment will not include details that can identify you, such as name or address.

All research projects must be reviewed and approved by [Insert LPS name] data access committee before they can use your data. Deidentified data never leaves the Trusted Research Environment and can only be accessed by approved UK based researchers.

If you wish to opt-out of sharing your data with the UKLLC please get in touch with the [Insert LPS name] Study Team.
```
*Credit: Extended Cohort for E-health, Environment and DNA (EXCEED)*

**Newsletter template: For LPS joining the UK LLC**
```
...
Within the SeRP, your pseudonymised health information will be linked with your [Insert LPS name] questionnaire data. Any information that could be used to identify you will be removed. 
...
Access to the anonymised linked data within UK LLC is very strictly controlled. Only UK-based researchers who have been approved by the Office for National Statistics (ONS), the UK LLC review panel and the [Insert LPS name] study team will be permitted to access it to conduct research. 
...
You have the right to withdraw your consent for data linkage, or to withdraw from the study altogether if you wish. To do so, contact the [Insert LPS name] Study Team: [Insert contact details]
```
...
Study name is a partner with UK Longitudinal Linkage Collaboration, a Trusted Research Environment set up to bring data together for research in the public good.
...
Where and how is [Insert LPS name] data stored at UK LLC? Study name data is stored on secure servers at SeRP UK, which are controlled by the University of Bristol and physically located at Swansea University. The servers are managed to information security best practice standards (including ISO 27001) and are regularly audited by external experts in information security.

Can I find out if [Insert LPS name] data held in the UK LLC Trusted Research environment has been approved for a research project? UK LLC has a Data Use Register - https://ukllc.ac.uk/data-use-register where you can view all approved and declined applications, with project summaries that provides a list of the UK LLC partner Longitudinal Population Studies that have been approved as part of each project and the aims of the research question.
...
**Website template: Transitioning from COVID-19 research to general research for public good**
```
Update on our partnership with UK Longitudinal Linkage Collaboration 
