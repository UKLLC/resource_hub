...
* LPS should consider equality/accessibility when determining whether to use electronic and postal mechanisms and while an electronic-only approach may be suitable in some LPS, for most a choice of physical media (i.e. postal materials) and electronic media should be offered.  
