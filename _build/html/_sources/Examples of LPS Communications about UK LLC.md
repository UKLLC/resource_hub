...
>
>When you joined <mark>[Insert LPS name]</mark> we asked for your permission to link to your electronic health records [adapt to wording used in your consent materials]. We will work with UK Longitudinal Linkage Collaboration (UK LLC) and the NHS to do this. It is important to know that researchers will never be able to identify you from the information you have given us combined with your health [adapt to wording used in your consent materials] records. 
>
...
>
>Watch here to see how it’s done. And find out more about UK LLC’s promises to keep your data safe and ensure it’s used for public good. 
>
...
> UK LLC works with [Insert LPS name] and NHS Digital Health, Swansea University and Care Wales. To see a video of how this linkage works click [here](https://www.youtube.com/watch?v=FXnHc8R3UW0).
>
>
...
>
> **Linkage to your health records**
><mark>[Insert LPS name]</mark> provides a list of personal data (e.g. name, date of birth, address) to NHS Digital Health and Care Wales (DHCW). They are a NHS Trusted Third Party, which means they have the official approvals in place to handle data in this way. They never see your study data. They then facilitate linkages by sending your personal identifiers with a unique identifier number to linked data owners [and UK LLC’s place-based (e.g. air pollution, noise pollution) modellers for processing]. These organisations extract and send de-identified datasets to SeRP UK Team at the Swansea University who bring them together with your study data (e.g your answers to surveys) using the unique identifier number. The SeRP UK Team then deposit your de-identified data into the UK LLC TRE. Through this split process, NHS Digital Health and Care Wales can only see your personal identifiers and SeRP UK and UK LLC Teams can only see de-identified data about you. Your de-identified linked data from [Insert LPS name] participants will be made available to approved researchers in the UK LLC Trusted Research Environment (TRE). This process ensures that there is no information that could be used to identify you in the UK LLC TRE.
>
> **How does this work?**
>
...
>
><mark>[Insert LPS name]</mark> provide the UK LLC with an anonymised copy of your data. To establish the linkage to health and wellbeing and other records we provide a list of your personal identifiers only (e.g. name, NHS ID, address) to the UK LLC. Only a small number of staff from the Universities of Bristol and Swansea can access the linked data.
>
...
>
>The data is stored on secure servers controlled by the University of Bristol (who are the Data Controller), the servers are located and run by the University of Swansea (who are the Data Processor for the University of Bristol). <mark>[Insert LPS name]</mark> remains the Data Controller for your data. At all times, we will determine whose records should be used in the UK LLC, which linkages can be established and which research teams can use your data and for which purposes. In this way, we make sure that all the principles of <mark>[Insert LPS name]</mark> are upheld. 
>
...
> * Your de-identified linked data from [Insert LPS name] participants will be made available to approved researchers via the SeRP Trusted Research Environment (TRE).
> * Data in the TRE will not include the name, address, or date of birth, any real world ID numbers (like NHS ID), names of places where you live or work, or the names or IDs of hospitals or other service providers.
